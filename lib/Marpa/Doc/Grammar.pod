...
If you prefer "C<proper>" separaration,
you can set
...
=item * Both have the same left hand symbol.

=item * Both have the same right hand symbol.

=item * Either both have no separator,
or both have the same separator.
