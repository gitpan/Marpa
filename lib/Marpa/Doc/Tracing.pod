...
Since the items in the earley sets use AHFA states,
you usually will want to call
L<C<Marpa::Grammar::show_AHFA>
|Marpa::Grammar/"show_AHFA"> as well.
The L<implementation document|Marpa::Implementation>
...
=item * Run C<show_AHFA> on the precomputed grammar.
