...
Marpa::Deprecated::Implementation - DEPRECATED Obsoleted Marpa Implementation

=head1 THIS DOCUMENT IS DEPRECATED

Most users should ignore this document.
It describes the implementation
with reference to a deprecated interface,
the 2nd Generation Evaluator described
...
L<Grune and Jacobs|Marpa::Advanced::Bibliography/"Grune and Jacobs 2008">.
...
earleme 3.
We can get a description of the AHFA states with the C<show_AHFA> method.
...
The LR(0) NFA state numbers may be ignored.
LR(0) automata are described in many of
the L<standard parsing
texts|Marpa::Advanced::Bibliography/"Grune and Jacobs 2008">.
The Aycock-Horspool Finite Automata (AHFA) is
built from the LR(0) NFA (Non-deterministic Finite Automata),
by a process that is described
in L<the Aycock-Horspool
paper|Marpa::Advanced::Bibliography/"Aycock and Horspool 2002">.
LR(0) automata and LR(0) state numbers
...
based on the ideas in L<Aycock and Horspool 2002|Marpa::Advanced::Bibliography/"Aycock and Horspool 2002">.
...
to an Earley set.
Let's look at scanning, and the transition to AHFA state 8,
first.
...
by Joop Leo|Marpa::Advanced::Bibliography/"Leo 1991"> to deal
...
The puts the end of parsing for our
