...
This sample L<Marpa::Evaluator::show_bocage|Marpa::Evaluator/"show_bocage">
output
is for the code in the appendix.
It is the same example used in L<Marpa::Implementation> and
...
This document is intended to be read after L<Marpa::Implementation>,
...
when L<Marpa::Evaluator::new|Marpa::Evaluator/"new"> is called,
